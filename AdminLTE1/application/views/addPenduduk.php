      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('data/kota') ?>">Kota</a></li>
        ...
        <div class="col-md-12">
          <div class="box box-primary box-solid">
            ...
            <div class="box-body" style="">
              <form class="col-sm-12" action="http://localhost/AdminLTE1/Penduduk/<?php if (isset($penduduk)) {
                echo "updatePenduduk";
              }else{echo "savePenduduk";} ?>" onsubmit="return confirm('<?php if(isset($penduduk)) {echo 'Update data dengan nik '.$penduduk->nik.' ?';}else{echo 'Buat data ?';} ?>')" method="post" enctype="multipart/form-data">
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="tempat_lahir" value="<?php if (isset($penduduk)) {echo $penduduk->tempat_lahir; }else {}?>" name="tempat_lahir" placeholder="tempat lahir" required>
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select id="jenis_kelamin" name="jenis_kelamin" class="form-control select2" style="width: 100%;" required>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select id="gol_darah" name="gol_darah" class="form-control select2" style="width: 100%;" required>
                        <?php if (isset($penduduk)) {?>
                          ...
                          <select id="status" name="status" class="form-control select2" style="width: 100%;" required>
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <div class="form-group col-md-12">
                                ...
                                <button class="btn btn-primary btn-lg" style="float:right;">Simpan</button>
                              </div>
