            ...
            <tbody>
              ...
              foreach($penduduk as $key) {?>
                <tr>
                  ...
                  <td>
                    <a href="<?php base_url() ?>editPenduduk/<?php echo $key->nik ?>" class="btn btn-warning" style="margin:3px;"><li class="glyphicon glyphicon-pencil"></li>&nbsp;Edit</a>
                    <button type="button" class="btn btn-primary" style="margin:3px;" onclick="viewDataPenduduk(<?php echo $key->nik ?>)" data-toggle="modal" data-target="#myModal"><li class="glyphicon glyphicon-zoom-in"></li>&nbsp;view</button>
                    <a style="margin:3px;" onclick="return confirm('Yakin ingin menghapus data dengan nik '+<?php echo $key->nik ?>)" href="<?php base_url() ?>deletePenduduk/<?php echo $key->nik ?>" class="btn btn-danger">Delete</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
